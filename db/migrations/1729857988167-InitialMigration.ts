...
export class InitialMigration1729857988167 implements MigrationInterface {
  name = 'InitialMigration1729857988167';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "terms-of-use" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "version" character varying NOT NULL, "content" character varying NOT NULL, CONSTRAINT "PK_01bfb1b779f1be54f54f10fa78d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user-terms-of-use" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "terms_of_use_id" integer NOT NULL, "accepted_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_6f491bd5ecf6124ae6114d139a6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
